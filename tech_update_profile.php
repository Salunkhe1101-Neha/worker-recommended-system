<?php 
    ...
    { 
        header("Locations:tech_login.php");
    }


    $technician_id = $_SESSION['technician_id'];

    $query = "SELECT * FROM technicians WHERE technician_id = " . $technician_id;
...
<div class="container p-3">
    <form class="form" action="tech_update_profile_code.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">                    
                    ...
                    <div class="col-lg-6 mt-4">
                        ...
                        <input type="number" name="adhar_no" class="form-control" id="exampleInputPassword1"
                            placeholder="Aadhaar Number" value="<?= $adhar_no;?>" required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4">
                        ...
                        <input type="text" name="experience" class="form-control" id="exampleInputPassword1"
                            placeholder="Aadhaar Number" value="<?= $experience;?>" required>
                    </div>
				    ...
				    { ?>
							<option value="<?php echo $row['category_id'] ;?>" <?php echo $row['category_id'] == $category_id ? 'selected' : '' ;?>> <?php echo $row['title'] ;?> </option>
			    <?php 	}
                    ?>
                        </select>
                    </div>
