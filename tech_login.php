...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5">
        <h1 class="display-3 text-white mb-4 animated slideInDown">Technician Login</h1>
...
<div class="container   mx-auto wow fadeInUp" data-wow-delay="0.1s" data-aos="fade-up">
    <div class="row justify-content-md-center">
        ...
        <?php              
            ...
            <form class="form" action="tech_login_code.php" method="POST" name="login">
                <label for="exampleInputEmail1">Email ID.</label>
                <input type="text"  class="form-control mt-2 mb-1" name="email"  placeholder="Email" required>
                ...
                <div class="ml-3 mt-2" style="color:rgb(7, 46, 7);">
                    <p class="link">Don't have an account? <a href="tech_register.php" style="color: rgb(236, 63, 63);">Registration Now</a></p>
                </div>
            </form>
        </div>
    </div>
